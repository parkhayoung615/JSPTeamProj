...
//	로그인 #해보자고 !!!
	...
	// 회원가입
	public int insertUser(String id, String password, String passwordOK, String name, String email, String phone,
			String addr, String m_addr, String d_addr, String birth) {
		int n = 0;
