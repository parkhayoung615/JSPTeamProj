		...
		<div id="header">
			<div class="header-wrap">
				...
				<ul class="login-list">
					...
					<li class="signin"><a href="./Signin.html"><i
					...
					<div class="order-content">
						<div class="content-wrap">
							...
							<ul class="content-list">
								<li class="content-item"><img src="./image/cake6.png"
									alt="주문상품" class="content-img">
									<div class="content-inf">Music is My Life...</div></li>
							</ul>
						</div>
					</div>
					...
					<div class="order-post">
						<div class="post-wrap">
							...
							<div class="post-infor">
								...
								<div class="post-sub3">
									<div class="sub2"><%= request.getParameter("taste") %></div>
								</div>
								<div class="post-sub4">
									<div class="sub3"><%= request.getParameter("color") %></div>
								</div>
								<div class="post-sub5">
									<div class="sub4"><%= request.getParameter("text") %></div>
								</div>
								<div class="post-sub6">
									<div class="sub5"><%= request.getParameter("want") %></div>
								</div>
							</div>
						</div>
					</div>
