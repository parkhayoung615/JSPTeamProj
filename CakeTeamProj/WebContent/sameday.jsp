                ...
                <div class="visual-wrap">
                    <div class="visual-wrap">
                        <ul class="visual-window">
                            <li class="slide-item"><img class="slide-img" src="image/cake.png" alt="케이크사진 1"></li>
                            <li class="slide-item"><img class="slide-img" src="image/cake9.png" alt="케이크사진 2"></li>
                            <li class="slide-item"><img class="slide-img" src="image/cake15.jpg" alt="케이크사진 3"></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div id="category-sidebar">
                <div class="category-sidebar-wrap">
                    <ul class="category-sidebar-list">
                        <div class="category-sidebar-list-item"><a href="./cake.jsp">Cake</a></div>
                        <div class="category-sidebar-list-item"><a href="./customCake.jsp">Custom Cake</a></div>
                        <div class="category-sidebar-list-item"><a href="./sameday.jsp">Same-Day Pickup</a></div>
                    </ul>
                </div>
            </div>
            <div id="product">
                <div class="product-wrap">
                    <div class="all-product-tit">
                        <h2 class="tit">Same-Day Pickup</h2>
                    </div>
